...
**Baseline**: `context-pipe v0.5.5` | `semantic-sift v0.3.5`
...
| :--- | :--- | :--- | :--- |
| **`context-pipe`** | `v0.5.5` | 2026-05-31 | Updated via lab_update.py — commit `043634a` fixes REPORT_041 (MCP node launch hang). |
